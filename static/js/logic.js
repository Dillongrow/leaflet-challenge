// Store our API endpoint as query_Url
let query_Url = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson";
...
function chooseColor(magnitude){
  return magnitude >= 5 ? "blue": magnitude >= 4 ? "green": magnitude >= 3 ? "gold": magnitude >= 2 ? "purple": magnitude >= 1 ? "lightgray": "lightpink";
}
